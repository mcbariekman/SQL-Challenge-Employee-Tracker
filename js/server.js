async function insertData() {
  ...
  const departmentQuery = {
    text: 'INSERT INTO department (id, name) VALUES ($1, $2)',
  };
  ...
  const roleQuery = {
    text: 'INSERT INTO role (id, title, salary, department_id) VALUES ($1, $2, $3, $4)',
  };
  ...
  const employeeQuery = {
    text: 'INSERT INTO employee (id, first_name, last_name, role_id, manager_id) VALUES ($1, $2, $3, $4, $5)',
  };
